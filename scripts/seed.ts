...
import { SecurityUtils } from '../src/core/utils/security.js';
...
  const rrhhPassword = await SecurityUtils.hashPassword('rrhh123');
  const empleadoPassword = await SecurityUtils.hashPassword('empleado123');
