...
const dateString = z
  ...
  .refine(
    ...
    'Debe ser una fecha válida en formato ISO o YYYY-MM-DD'
  )
...
export const PayrollCreateSchema = z.object({
  ...
  departmentId: z
    .string()
    .min(1, 'El ID del departamento no puede estar vacío') 
    .optional(),
  description: z
    .string()
...
export const PayrollQuerySchema = z.object({
  startDate: z
    ...
    .refine(
      ...
      'Debe ser una fecha de inicio válida'
    )
    .optional(),
  endDate: z
    .string()
    .refine(
      (str) => !str || !isNaN(Date.parse(str)),
      'Debe ser una fecha de fin válida'
    )
    .optional(),
...
export const PayrollItemSchema = z.object({
  employeeId: z
    .string()
    .min(1, 'El ID de empleado no puede estar vacío'), 
