...
export class AuthController {
  ...
  async login(req: Request<{}, {}, LoginRequest>, res: Response) {
    try {
      ...
      sendSuccess(res, result, 'Login exitoso', 200);
    } catch (error: unknown) { 
  ...
  async refreshToken(req: Request<{}, {}, RefreshTokenRequest>, res: Response) {
    try {
      ...
      sendSuccess(res, result, 'Token refrescado exitosamente', 200);
    } catch (error: unknown) {
      const errorMessage = error instanceof Error ? error.message : 'Unknown error';
  ...
  async changePassword(req: Request<{}, {}, ChangePasswordRequest>, res: Response) {
    try {
      ...
      sendSuccess(res, result, 'Contraseña cambiada exitosamente', 200);
    } catch (error: unknown) {
      const errorMessage = error instanceof Error ? error.message : 'Unknown error';
  ...
  async getCurrentUser(req: Request, res: Response) {
    try {
      ...
      sendSuccess(res, result, 'Perfil de usuario obtenido', 200);
    } catch (error: unknown) {
      const errorMessage = error instanceof Error ? error.message : 'Unknown error';
  ...
  async logout(req: Request, res: Response) {
    try {
      ...
      sendSuccess(res, result, 'Sesión cerrada exitosamente', 200);
    } catch (error: unknown) {
